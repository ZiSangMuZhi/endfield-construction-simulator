...
本轮没有下载、生成或复制新的设备/物品图片。拆解机、提纯机、紫晶质瓶（清水/污水/锦草溶液）、赤铜粉末、壤晶、赫铜块、壤晶废液、惰性壤晶废液、沉积酸、赤铜溶液和赫铜溶液的数据记录暂不设置 `image`，由界面显示具名“待补图”内容占位。用户后续提供图片时，应在这里逐项登记文件、来源、许可与修改情况后再接入稳定 ID。
